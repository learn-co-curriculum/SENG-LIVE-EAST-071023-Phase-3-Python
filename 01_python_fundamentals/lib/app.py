...
if pet_mood == "Hungry!":  # pet mood is NOT rowdy.
    print(f"{pet_name} needs to be fed.")
elif pet_mood == "Rowdy!":
    print(f"{pet_name} needs a walk.")
else: # pet mood is NOT rowdy and NOT hungry
...
# my_str = "Bring an umbrella" if rainy else "don't bring an umbrella"
# print(my_str)

#bring an umbrella if it is rainy otherwise do not
# [do something] (if cond) else [do something else]
